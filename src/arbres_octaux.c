...
arbre_octal genere_arbre_octal(int profondeur_arbre, int x1, int y1, int z1, int x2, int y2, int z2){
    ...
    A->fils1 = genere_arbre_octal(profondeur_arbre - 1, x1, y1, z1, x2/2, y1/2, z2/2);

    A->fils2 = genere_arbre_octal(profondeur_arbre - 1, x2/2, y1, z1, x2/2, y1/2, z2/2);

    A->fils3 = genere_arbre_octal(profondeur_arbre - 1, x1, y1, z2/2, x2/2, y1/2, z2/2);

    A->fils4 = genere_arbre_octal(profondeur_arbre - 1, x2/2, y1, z2/2, x2/2, y1/2, z2/2);

    A->fils5 = genere_arbre_octal(profondeur_arbre - 1, x1, y1/2, z1, x2/2, y2, z2/2);

    A->fils6 = genere_arbre_octal(profondeur_arbre - 1, x2/2, y1/2, z1, x2/2, y2, z2/2);

    A->fils7 = genere_arbre_octal(profondeur_arbre - 1, x1, y1/2, z2/2, x2/2, y2, z2/2);

    A->fils8 = genere_arbre_octal(profondeur_arbre - 1, x2/2, y1/2, z2/2, x2/2, y2, z2/2);
